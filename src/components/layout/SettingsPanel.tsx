...
import { Settings, Globe, Database, Sparkles, Plus, Trash2, ArrowRight, Pencil } from 'lucide-react';
...
export default function SettingsPanel() {
  ...
  const handleSeedData = async () => {
    setSeeding(true);
    try {
      // 1. Seed Creative Writing Prompt
      await addPrompt(
  ...
  return (
    <>
      <div 
        id="settings-panel"
        className="w-80 border-l border-white/10 bg-[#0a0a0c]/85 backdrop-blur-2xl p-5 flex flex-col justify-between z-30 transition-all duration-300 transform overflow-hidden"
      >
        <div className="space-y-6 overflow-y-auto flex-1 pr-1 custom-scrollbar">
          ...
          <div className="space-y-3">
            ...
            {/* Prompt list with hover actions */}
            {prompts.length > 0 && (
                ...
                <div className="max-h-[30vh] overflow-y-auto space-y-2 pr-1 custom-scrollbar">
                  {prompts.map((p) => (
                    ...
                    >
                      ...
                      {/* Hover Buttons: Dos bolas flotantes */}
        ...
        {/* Status */}
        <div className="rounded-xl border border-white/5 bg-white/[0.02] p-4 space-y-2 shrink-0">
